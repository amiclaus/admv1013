...
#define ADMV1013_REG_QUAD			0x04
#define ADMV1013_REG_LO_AMP_PHASE_ADJUST1	0x05
#define ADMV1013_REG_MIXER   			0x07
#define ADMV1013_REG_IF_AMP  			0x08
#define ADMV1013_REG_IF_AMP_BB_AMP		0x09
#define ADMV1013_REG_BB_AMP_AGC			0x0A
#define ADMV1013_REG_VVA_TEMP_COMP		0x0B
...
#define ADMV1013_IBIAS_PD_MSK       		BIT(14)
#define ADMV1013_IBIAS_PD(x)         		FIELD_PREP(ADMV1013_IBIAS_PD_MSK, x)
#define ADMV1013_P1DB_COMPENSATION_MSK		GENMASK(13, 12)
#define ADMV1013_P1DB_COMPENSATION(x)         	FIELD_PREP(ADMV1013_P1DB_COMPENSATION_MSK, x)
#define ADMV1013_IF_AMP_PD_MSK			BIT(11)
#define ADMV1013_IF_AMP_PD(x)         		FIELD_PREP(ADMV1013_IF_AMP_PD_MSK, x)
#define ADMV1013_QUAD_BG_PD_MSK			BIT(9)
#define ADMV1013_QUAD_BG_PD(x)         		FIELD_PREP(ADMV1013_QUAD_BG_PD_MSK, x)
#define ADMV1013_BB_AMP_PD_MSK			BIT(8)
#define ADMV1013_BB_AMP_PD x)         		FIELD_PREP(ADMV1013_BB_AMP_PD_MSK, x)
#define ADMV1013_QUAD_IBIAS_PD_MSK		BIT(7)
#define ADMV1013_QUAD_IBIAS_PD(x)         	FIELD_PREP(ADMV1013_QUAD_IBIAS_PD_MSK, x)
#define ADMV1013_DET_EN_MSK			BIT(6)
#define ADMV1013_DET_EN(x)         		FIELD_PREP(ADMV1013_DET_EN_MSK, x)
#define ADMV1013_BG_PD_MSK			BIT(5)
...
/* ADMV1013_LO_AMP_PHASE_ADJUST1 Map */
#define ADMV1013_LOAMP_PH_ADJ_I_FINE_MSK	GENMASK(15, 9)
#define ADMV1013_LOAMP_PH_ADJ_I_FINE(x)        	FIELD_PREP(ADMV1013_LOAMP_PH_ADJ_I_FINE_MSK, x)
#define ADMV1013_LOAMP_PH_ADJ_Q_FINE_MSK	GENMASK(8, 2)
#define ADMV1013_LOAMP_PH_ADJ_Q_FINE(x)        	FIELD_PREP(ADMV1013_LOAMP_PH_ADJ_Q_FINE_MSK, x)

/* ADMV1013_REG_MIXER Map */
#define ADMV1013_MIXER_VGATE_MSK		GENMASK(15, 9)
#define ADMV1013_MIXER_VGATE(x)        		FIELD_PREP(ADMV1013_MIXER_VGATE_MSK, x)
#define ADMV1013_DET_PROG_MSK			GENMASK(6, 0)
#define ADMV1013_DET_PROG(x)			FIELD_PREP(ADMV1013_DET_PROG_MSK, x)

/* ADMV1013_REG_IF_AMP Map */
#define ADMV1013_IF_AMP_COARSE_GAIN_I_MSK	GENMASK(11, 8)
#define ADMV1013_IF_AMP_COARSE_GAIN_I(x)  	FIELD_PREP(ADMV1013_IF_AMP_COARSE_GAIN_I_MSK, x)
#define ADMV1013_IF_AMP_FINE_GAIN_Q_MSK		GENMASK(7, 4)
#define ADMV1013_IF_AMP_FINE_GAIN_Q(x)		FIELD_PREP(ADMV1013_IF_AMP_FINE_GAIN_Q_MSK, x)
#define ADMV1013_IF_AMP_FINE_GAIN_I_MSK		GENMASK(7, 4)
#define ADMV1013_IF_AMP_FINE_GAIN_I(x)		FIELD_PREP(ADMV1013_IF_AMP_FINE_GAIN_I_MSK, x)

/* ADMV1013_REG_IF_AMP_BB_AMP Map */
#define ADMV1013_IF_AMP_COARSE_GAIN_Q_MSK	GENMASK(15, 12)
#define ADMV1013_IF_AMP_COARSE_GAIN_Q(x)  	FIELD_PREP(ADMV1013_IF_AMP_COARSE_GAIN_Q_MSK, x)
#define ADMV1013_BB_AMP_OFFSET_Q_MSK		GENMASK(9, 5)
#define ADMV1013_BB_AMP_OFFSET_Q(x)		FIELD_PREP(ADMV1013_BB_AMP_OFFSET_Q_MSK, x)
#define ADMV1013_BB_AMP_OFFSET_I_MSK		GENMASK(4, 0)
#define ADMV1013_BB_AMP_OFFSET_I(x)		FIELD_PREP(ADMV1013_BB_AMP_OFFSET_I_MSK, x)

/* ADMV1013_REG_BB_AMP_AGC Map */
#define ADMV1013_BB_AMP_REF_GEN_MSK		GENMASK(6, 3)
#define ADMV1013_IF_AMP_COARSE_GAIN_Q(x)  	FIELD_PREP(ADMV1013_IF_AMP_COARSE_GAIN_Q_MSK, x)
#define ADMV1013_BB_AMP_GAIN_CTRL_MSK		GENMASK(2, 1)
#define ADMV1013_BB_AMP_GAIN_CTRL(x)		FIELD_PREP(ADMV1013_BB_AMP_GAIN_CTRL_MSK, x)
#define ADMV1013_BB_SWITCH_HIGH_LOW_CM_MSK	BIT(0)
#define ADMV1013_BB_SWITCH_HIGH_LOW_CM(x)	FIELD_PREP(ADMV1013_BB_SWITCH_HIGH_LOW_CM_MSK, x)
